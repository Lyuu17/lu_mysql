...
to the following restrictions:
		...
		Modified for Liberty Unleashed by the Liberty Unleashed Team.
*/
#ifndef _SQUIRREL_H_
#define _SQUIRREL_H_
...
typedef SQInteger (*SQSUSPENDFUNCTION)(HSQUIRRELVM);
...
SQUIRREL_API void sq_setquerysuspendfunc(HSQUIRRELVM v, SQSUSPENDFUNCTION func);
...
SQUIRREL_API void sq_pop(HSQUIRRELVM v,SQUnsignedInteger nelemstopop);
...
SQUIRREL_API SQRESULT sq_getnativeclosurename(HSQUIRRELVM v,SQInteger idx, const SQChar **c);
